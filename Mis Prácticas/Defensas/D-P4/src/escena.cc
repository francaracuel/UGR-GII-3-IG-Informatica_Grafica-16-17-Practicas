    ...
    // Práctica 3
        ...
        switch(tolower(Tecla1)){
            ...
            case 'g':
                ...
                bool defensa4 = !obj2->getLight()->getDefensa4();
                
                for(unsigned int i=0; i<dynamic_cast<Can*>(obj)->getListObj().size(); i++){                
                    dynamic_cast<Can*>(obj)->getListObj()[i]->getLight()->setDefensa4(defensa4);
                }
                obj2->getLight()->setDefensa4(defensa4);
                obj3->getLight()->setDefensa4(defensa4);
                obj4->getLight()->setDefensa4(defensa4);
                break;

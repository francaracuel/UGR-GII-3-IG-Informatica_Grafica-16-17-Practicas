...
// Crea la geometría el objeto PLY con una textura determinada
//
ObjPLY::ObjPLY(bool ask, string nameTexture, bool generateAutomatic){
...
// Crea la geometría el objeto PLY sin preguntar por el archivo ply con una
// textura determinada
//
ObjPLY::ObjPLY(bool ask, string f, string nameTexture, bool generateAutomatic) :
    file(f){
...
// Crea la geometría el objeto PLY sin preguntar por el archivo ply y añade
// la textura
//
ObjPLY::ObjPLY(bool ask, string f, vector<float> colors, string name, 
        bool generateAutomatic) : ObjPLY(ask, f, colors){
